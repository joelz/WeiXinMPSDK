...
namespace Senparc.Weixin.MP.Sample.Controllers
{
    public class OAuthController : Controller
    {
        ...
        public ActionResult Index(string returnUrl)
        {
            ...
            returnUrl = "https://weixin.dc1979.com/oauth/SPA";

            var authUrl =
                OAuthApi.GetAuthorizeUrl(appId,
                "https://weixin.dc1979.com/oauth/BaseCallback?returnUrl=" + returnUrl.UrlEncode(),
        ...
        public ActionResult BaseCallback(string code, string state, string returnUrl)
        {
            ...
            catch (ErrorJsonResultException ex)
            {
                ...
                return Content("用户已授权，授权Token：" + result + ex.JsonResult.ToString());
            }
        }
